...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BROKERCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BROKERCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BROKERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BROKERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BROKERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BROKERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BROKERCATEGORY actions', async () => {
      const expectedActions = [
        {
