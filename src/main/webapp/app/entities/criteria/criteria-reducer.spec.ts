...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRITERIA_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRITERIA actions', async () => {
      const expectedActions = [
        {
