...
import { searchEntities, getEntities } from './department.reducer';
      ...
      <h2 id="department-heading" data-cy="DepartmentHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="jhipsterSampleApplicationApp.department.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {departmentList && departmentList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.department.id">ID</Translate>
                </th>
                <th>
