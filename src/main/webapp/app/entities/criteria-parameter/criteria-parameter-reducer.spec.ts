...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './criteria-parameter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRITERIAPARAMETER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRITERIAPARAMETERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRITERIAPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRITERIAPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRITERIAPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRITERIAPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRITERIAPARAMETER actions', async () => {
      const expectedActions = [
        {
