...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIONPARAMETER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACTIONPARAMETERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACTIONPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIONPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIONPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIONPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIONPARAMETER actions', async () => {
      const expectedActions = [
        {
