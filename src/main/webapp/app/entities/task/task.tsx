      ...
      <h2 id="task-heading" data-cy="TaskHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="jhipsterSampleApplicationApp.task.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {taskList && taskList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.task.id">ID</Translate>
                </th>
                <th>
