...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTOMATEDACTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_AUTOMATEDACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_AUTOMATEDACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUTOMATEDACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUTOMATEDACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUTOMATEDACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUTOMATEDACTION actions', async () => {
      const expectedActions = [
        {
