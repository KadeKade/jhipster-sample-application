...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRITERIASET_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRITERIASETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRITERIASET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRITERIASET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRITERIASET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRITERIASET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRITERIASET actions', async () => {
      const expectedActions = [
        {
