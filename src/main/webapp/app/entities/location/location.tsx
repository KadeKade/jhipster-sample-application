      ...
      <h2 id="location-heading" data-cy="LocationHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="jhipsterSampleApplicationApp.location.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {locationList && locationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.location.id">ID</Translate>
                </th>
                <th>
